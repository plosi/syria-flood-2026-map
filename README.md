...
The workflow follows the core design pattern of operational flood mapping (SAR-primary detection, permanent-water exclusion, sensor fusion), with topographic and field validation identified as the next steps required before results support anything beyond screening.
The outputs should be used as a screening and prioritisation tool, not as a definitive assessment of infrastructure damage. The analysis identifies likely impacted water stations, supports planning of field verification missions, and helps prioritize water quality testing and infrastructure inspections.
